...
This project includes or links against the following third-party software and assets.
...
- **License:** MIT License
- **Location:** `lib/rmlui/` (git submodule)
- **License file:** `lib/rmlui/LICENSE.txt`

## LibreQuake

- **Source:** https://github.com/lavenderdotpet/LibreQuake
- **License:** BSD License
- **Location:** `id1/` (downloaded PAK files via `make setup`)
