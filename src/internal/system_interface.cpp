...
SystemInterface::SystemInterface () : m_engine_realtime (nullptr), m_start_time (0.0) {}
...
void SystemInterface::SetMouseCursor (const Rml::String &cursor_name)
{
	...
	if (cursor_name.empty () || cursor_name == "arrow")
		...
		cursor_name == "resize" || cursor_name == "ew-resize" || cursor_name == "ns-resize" || cursor_name == "nesw-resize" || cursor_name == "nwse-resize")
	...
	else if (cursor_name == "not-allowed" || cursor_name == "no-drop" || cursor_name == "wait" || cursor_name == "progress")
